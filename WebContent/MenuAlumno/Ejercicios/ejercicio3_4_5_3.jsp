	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<h5>Completa los Angulos con los valores correspondientes</h5>		
			 ...
			 <img src="<%=request.getContextPath()%>/MenuAlumno/img/ejercicio3_4_5_3.jpg" style="width:600px;height:400px;"> 
			
			<select name="respuesta">
			        <option value="" selected>Elije la Respuesta</option>
