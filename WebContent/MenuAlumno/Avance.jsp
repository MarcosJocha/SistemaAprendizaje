...
<%
	...
	String alumno=oPersona.getNombre()+" "+oPersona.getApePaterno()+" "+oPersona.getApeMaterno();
			...
			<table class="table table-bordered">
						<thead>
							<tr>
								...
								<th>Curso</th>
								<th>Tema</th>
								<th>Cantidad Ejercicios Realizados</th>
								<th>Mayor Numero Intentos</th>
								<th>Promedio</th>
								<th>Avance</th>
							</tr>
						</thead>
						...
						<% for(int i=0; i<listaEvaluaciones.size(); i++){ %>
							<tr>
								...
								<td><%=listaEvaluaciones.get(i).getCantidadEjercicios() %></td>
								<td><%=listaEvaluaciones.get(i).getMayornumIntentos() %></td>
								<td><%=listaEvaluaciones.get(i).getPromedio() %></td>
								<td><a href=""><i class="download-icons">Ver Avance</i></a></td>
							</tr>
						<% } %> 
						</tbody>
					</table>
