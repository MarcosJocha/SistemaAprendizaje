...
<%
Vector<Persona> listaAlumnos=(Vector)request.getAttribute("alumnos");
			...
			<table data-search="true" id="table_telefono" data-height="600"
						...
						<% for(int i=0; i<listaAlumnos.size(); i++){ %>
							<tr>
								...
								<%if(listaAlumnos.get(i).equals("1")){ %>
								<td>Por Revisar</td>
								<%}else{ %>
								<td>Revisado</td>
								<%} %>
								<td><a href="Gestionar_Docente?f=eliminarDocente&dato=<%=listaAlumnos.get(i).getIdPersona() %>")>
