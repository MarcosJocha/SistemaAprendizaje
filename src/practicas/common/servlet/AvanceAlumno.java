...
@WebServlet("/avanceAlumno")
public class AvanceAlumno extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			listaEvaluaciones = oDAOFactory.getFunctions().getPracticas().AvanceAlumno(idAlumno);
		...
		request.getRequestDispatcher("/MenuAlumno/Avance.jsp").forward(request, response);
